...
import com.example.marin.mobileradninalog.tabs.adapters.FirmaSpinnerAdapter;
import com.example.marin.mobileradninalog.tabs.adapters.PeopleSpinnerAdapter;

import java.util.ArrayList;
import java.util.Calendar;

public class NoviZahtjevActivity extends AppCompatActivity implements SearchResultReceiver.Receiver {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noviZahtjevToolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NoviZahtjevActivity.this.finish();
            }
        });
...
//        postavljanje datuma
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(NoviZahtjevActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            public void onClick(View v) {
                try {
                    if (hitna.isChecked() && normalna.isChecked()) {
                        Toast.makeText(NoviZahtjevActivity.this, "Odznačite jednu vrstu intervencije", Toast.LENGTH_SHORT).show();
                    } else if (hitna.isChecked()) {
                        isHitno = true;
                    } else if (normalna.isChecked()) {
                        isHitno = false;
                    } else {
                        Toast.makeText(NoviZahtjevActivity.this, "Popunite sva polja", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    if (date.getText().toString().equals("")) {
                        ...
                        if (unesiteOpis.getText().toString().isEmpty()) {
                            Toast.makeText(NoviZahtjevActivity.this, "Unesite opis problema", Toast.LENGTH_SHORT).show();
                        } else {
